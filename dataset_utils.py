...
class ImageCaptioningDataset():
    ...
    def create_vegetable_dictionary(folder_path, destination_folder):
        ...
        for item in os.listdir(folder_path):
            ...
            if os.path.isdir(item_path):
                ...
                captions.extend(ImageCaptioningDataset.create_vegetable_dictionary(item_path, destination_folder))
            else:
    ...
    @staticmethod
    def handle_dataset(destination_folder, captions):
        # add metadata.jsonl file to this folder
        root = destination_folder + "/metadata.jsonl"
    ...
    @staticmethod
    def train_dataload(train_dataset):
        return DataLoader(train_dataset, shuffle=True, batch_size=2)
